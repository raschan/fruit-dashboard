<div class='wizard ui-wizard'>
  <div class='wizard-wrapper'>
    <ul class='wizard-steps' style='left:0px;'>
      <li data-target='#google-connect-step-1' @if($stepNumber == 1)class='active'@endif>
        <span class='wizard-step-number'>1</span>
        <span class='wizard-step-caption'>Step 1
          <span class='wizard-step-description'>Credentials</span>
        </span>
      </li>
      <li data-target='#google-connect-step-2' @if($stepNumber == 2)class='active'@endif>
        <span class='wizard-step-number'>2</span>
        <span class='wizard-step-caption'>Step 2
          <span class='wizard-step-description'>Keep synchronized</span>
        </span>
      </li>
      <li data-target='#google-connect-step-3' @if($stepNumber == 3)class='active'@endif>
  ...
  <div class='wizard-content'>
    <div class='wizard-pane' id='google-connect-step-1' @if($stepNumber == 1)style='display:block;opacity:1;'@endif>
      <div class='row'>
        <div class='col-sm-8 col-sm-offset-2'>
          <h3>First input and save your Google API keys</h3>
          <p class='text-danger small'>For added security follow the steps on the right to create a read-only API key in your Google account</p>
          {{ Form::open(array(
                  'action' => 'ConnectController@doGoogleConnect',
                  'id' => 'form-connect-google',
                  'role' => 'form',
    ...
    </div> {{-- /google-connect-step-1 --}}
    
    <div class='wizard-pane' id='google-connect-step-2' @if($stepNumber == 2)style='display:block;opacity:1;'@endif>
      <div class='row'>
        <div class='col-sm-8 col-sm-offset-2'>
          <h3>Add this webhook to keep your data synced</h3>
          <p class='top-space bottom-space well well-sm'>
            @if($user->isGoogleCredentialsValid())
              <span class='text-danger'><strong>{{ URL::secure('api/events/google').'/'.$user->btWebhookId }}</strong></span>
            @else
    ...
    </div> {{-- /google-connect-step-2 --}}
    <div class='wizard-pane' id='google-connect-step-3' @if($stepNumber == 3)style='display:block;opacity:1;'@endif>
      <div class='row'>
        <div class='col-sm-8 col-sm-offset-2'>
          <div class='text-center'>
            <h3>To finish, import your data</h3>
            <a href="{{ URL::to('import/google') }}" class='btn btn-primary btn-lg'>Import</a>
          </div>
